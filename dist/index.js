...
var prototypeAccessors$2 = { size: { configurable: true },border: { configurable: true },posBefore: { configurable: true },posAtStart: { configurable: true },posAfter: { configurable: true },posAtEnd: { configurable: true },contentLost: { configurable: true },domAtom: { configurable: true },ignoreForCoords: { configurable: true } };
...
// start/end tokens.
prototypeAccessors$2.border.get = function () { return 0 };
...
prototypeAccessors$2.posBefore.get = function () {
  return this.parent.posBeforeChild(this)
};

prototypeAccessors$2.posAtStart.get = function () {
  return this.parent ? this.parent.posBeforeChild(this) + this.border : 0
};

prototypeAccessors$2.posAfter.get = function () {
  return this.posBefore + this.size
};

prototypeAccessors$2.posAtEnd.get = function () {
...
prototypeAccessors$2.contentLost.get = function () {
...
prototypeAccessors$2.domAtom.get = function () { return false };

prototypeAccessors$2.ignoreForCoords.get = function () { return false };

Object.defineProperties( ViewDesc.prototype, prototypeAccessors$2 );
...
((assign = prosemirrorModel.DOMSerializer.renderSpec(document, node.type.spec.toDOM(node)), dom = assign.dom, contentDOM = assign.contentDOM));
  ...
  NodeViewDesc.prototype.parseRule = function parseRule () {
    ...
    else { rule.getContent = function () { return this$1$1.contentDOM ? prosemirrorModel.Fragment.empty : this$1$1.node.content; }; }
    return rule
  };
  ...
  NodeViewDesc.prototype.updateChildren = function updateChildren (view, pos) {
    ...
    iterDeco(this.node, this.innerDeco, function (widget, i, insideNode) {
      if (widget.spec.marks)
        ...
        { updater.syncToMarks(i == this$1$1.node.childCount ? prosemirrorModel.Mark.none : this$1$1.node.child(i).marks, inline, view); }
...
var MouseDown = function MouseDown(view, pos, event, flushed) {
  ...
  if (event.button == 0 &&
      ...
      selection instanceof prosemirrorState.NodeSelection && selection.from <= targetPos && selection.to > targetPos)
...
var prototypeAccessors = { props: { configurable: true },root: { configurable: true },isDestroyed: { configurable: true } };
...
// used anymore).
prototypeAccessors.isDestroyed.get = function () {
